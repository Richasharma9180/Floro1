<?php /* /home/supriyagadhave/floro/resources/views/users/create.blade.php */ ?>
<?php $__env->startSection('content'); ?>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Add User Account')); ?></div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('create')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="user_name" type="text" class="form-control<?php echo e($errors->has('user_name') ? ' is-invalid' : ''); ?>" name="user_name" value="<?php echo e(old('name')); ?>" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="house_number" class="col-md-4 col-form-label text-md-right"><?php echo e(__('House Number')); ?></label>
                        ...
                        <div class="form-group row">
                            <label for="postal_code" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Postal Code')); ?></label>
